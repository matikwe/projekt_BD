...
if(isset($_POST['title']) && isset($_POST['director']) && isset($_POST['category']) && isset($_POST['year']) && isset($_POST['age']) && isset($_POST['price'])) {
    $dbh->query("INSERT INTO FILMY (ID_KATEGORIA, TYTUL, ID_REZYSER, ROK_WYDANIA, PRZEDZIAL_WIEKOWY, BIEZACA_CENA) 
                            VALUES ('".$_POST['category']."', '".$_POST['title']."', '".$_POST['director']."', '".$_POST['year']."', '".$_POST['age']."', '".$_POST['price']."')");
