...
if(isset($_POST['title']) && isset($_POST['director']) && isset($_POST['category']) && isset($_POST['year']) && isset($_POST['age']) && isset($_POST['price1']) && isset($_POST['price2'])) {
    ...
    $query = $dbh->query("UPDATE FILMY SET ID_KATEGORIA=".$_POST['category'].", TYTUL='".$_POST['title']."', ID_REZYSER=".$_POST['director'].", ROK_WYDANIA=".$_POST['year'].", PRZEDZIAL_WIEKOWY=".$_POST['age'].", BIEZACA_CENA=".$price." WHERE ID_FILM=".$_SESSION['ID']);
