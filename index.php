...
$actions = array('home', 'login', 'registration', 'logout','adminPanel', 'moviesList', 'actorsList', 'addActor','partnerProgram', 'categoriesList', 'addCategories'); //wpisywać stworzone podstrony
